...
const description =
  "Your privacy is important to us. It is Berrys's policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website and other sites we own and operate.";
    ...
    <div className="relative flex items-center justify-center border-x border-b border-dotted">
      ...
      <div className="prose prose-primary dark:prose-invert py-12">
        ...
        <p>
          ...
          purpose of publication, processing, or usage on our platform. All
          user-generated content is associated with the account or email address
          used to submit the materials.
        </p>
        <p>
        ...
        <p>
          The Berrys Subprocessor List identifies subprocessors authorized to
          subprocess customer or personal data on behalf of Berrys to provide
        ...
        <p>
          ...
          organizations (known as “data processors”). We, Berrys, located at the
        ...
        <p>
          ...
          account, we will delete your personal information within 30 days of
