...
const description =
  'This acceptable use policy covers the products, services, and technologies (collectively referred to as the "Products") provided by Berrys under any ongoing agreement.';
  ...
  <div className="relative grid w-full grid-cols-[0.2fr_3fr_0.2fr] md:grid-cols-[0.5fr_3fr_0.5fr]">
    ...
    <div className="relative flex items-center justify-center border-x border-b border-dotted">
      ...
      <div className="prose prose-primary dark:prose-invert py-12">
        ...
        <p>
          Berrys customers found engaging in activities prohibited by this
        ...
        <h3>Unauthorized use of Berrys property</h3>
        <p>
          We prohibit the impersonation of Berrys, the representation of a
          significant business relationship with Berrys, or ownership of any
          Berrys property (including our Products and brand) for the purpose of
