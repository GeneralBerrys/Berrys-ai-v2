...
export const SignupEmailTemplate = ({
  ...
  <Html>
    <Head />
    <Preview>Confirm your email address to get started with Berrys</Preview>
    <EmailLayout>
      <Text className="text-left text-[#525f7f] text-base leading-6">
        Thanks for signing up for Berrys! To complete your registration, please
      ...
      <Text className="text-left text-[#525f7f] text-base leading-6">
        This link will expire in 10 minutes. If you didn't sign up for Berrys,
...
SignupEmailTemplate.PreviewProps = {
  magicLink: 'https://www.berrys.ai/sign-up',
  email: 'test@test.com',
